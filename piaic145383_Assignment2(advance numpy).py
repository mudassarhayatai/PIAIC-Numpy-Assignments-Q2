...
def function5():
    ...
    z = np.zeros((5,5),dtype='int') #wrtie your code here
...
def function8():
    ...
    x = np.ones((2,5),dtype='int32')*6 #write your code here
...
def function14():
    ...
    ans = np.split(arr,[2,4],axis=0) #write your code here 
